            ...
            while (invalidQuest){
                ...
                if (namaQuest.matches("^[a-zA-Z0-9\\s]+$")){
                    ...
                    if (deskQuest.matches("^[a-zA-Z0-9\\s]+$")){
                        ...
                        if(rewardInput.matches("^[0-9]+$")){
                            rewardQuest = Integer.parseInt(rewardInput);
                            if (rewardQuest > 0){
                                if(expInput.matches("^[0-9]+$")){
                                        ...
                                        if (difficultQuest.matches("^[a-zA-Z\\s]+$")){
                                            switch (difficultQuest.toLowerCase()) {
                                                case "mudah":
                                                    ...
                                                    invalidQuest = false;
                                                    questData += "Q" + (questId++) + "," + namaQuest + "," + deskQuest + "," + rewardQuest + "," + expQuest + "," + "\u2605" + "," + "Tersedia \ud93d\n";
                                                    break;
                                                case "menengah":
                                                    System.out.println("Quest berhasil di tambahkan.");
                                                    invalidQuest = false;
                ...
                if (nameTravel.matches("^[a-zA-Z0-9\\s]+$")){
                    switch (Integer.parseInt(levelTravel)) {
                        case 1:
                            ...
                            travelerData += "P" + (travelerId++) + "," + nameTravel + "," + levelTravel + "," + 0 + "," + "Kosong \u2705\n";
                            invalidTravel = false;
                            break;
                        case 2:
                        case 3:
                        ...
                        case 20:
                            System.out.println("Pengembara berhasil ditambahkan.");
                            System.out.println("Data berhasil di masukkan");
                            travelerData += "P" + (travelerId++) + "," + nameTravel + "," + levelTravel + "," + (5000*2^(Integer.parseInt(levelTravel)-2)) + "," +"Kosong \u2705\n";
                            invalidTravel = false;
                            break;
                        default:
        ...
        while (running) {
            ...
            switch (choice) {
                                        ...
                                        default:
                                            if (deskQuest.matches("^[a-zA-Z0-9\\s]+$")){
                                                ...
                                                switch (rewardInput) {
                                                    ...
                                                    default:
                                                        if(rewardInput.matches("^[0-9]+$")){
                                                            int rewardQuest = Integer.parseInt(rewardInput);
                        ...
                        switch (nameInput) {
                            ...
                            default:
                                if(nameInput.matches("^[a-zA-Z0-9\\s]+$")){
                                    ...
                                    if(levelInput.matches("^[0-9]+$")){
                                        levelTravel = Integer.parseInt(levelInput);
                                        if(levelTravel > 0){
                                            switch (levelTravel) {
                                            case 1:
                                                travelerData += "P" + (travelerId++) + "," + nameTravel + "," + levelTravel + "," + (5000*2^(levelTravel-2)) + "," +"Kosong \u2705\n";
                                                invalidInput = false;
                                                break;
                                            case 2:
                                            case 3:
                ...
                case "9":
                    ...
                    break;
                case "10":
                    System.out.println("Belum di implementasikan!");
                    break;
                case "11":
                    // TODO: Keluar
                    running = false;
